 ...
 *     as applicable.
*/
MODULE_NAME='RmsNlLightSystemMonitor'(DEV vdvRMS,
                                      DEV vdvDeviceModule,
...
CHAR MONITOR_DEBUG_NAME[] = 'RmsNlLightMon';
...
#IF_DEFINED HAS_LIGHT
    METADATA_PROPERTY_LIGHT_SCENE_COUNT        = 10;
#END_IF
...
DEFINE_FUNCTION RegisterAsset(RmsAsset asset)
{
  ...
  asset.assetType         = RMS_ASSET_TYPE_LIGHTSYSTEM;
...
#IF_DEFINED HAS_LIGHT
    CASE 'light.scene' :
    {
      SEND_COMMAND vdvDeviceModule,"'SCENEPRESET-',ITOA(nValue1)"
    }
#END_IF
