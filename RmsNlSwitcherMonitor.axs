...
CHAR MONITOR_ASSET_DESCRIPTION[]      = '3G SDI Switcher';
CHAR MONITOR_ASSET_MANUFACTURERNAME[] = 'Blackmagic Design';
CHAR MONITOR_ASSET_MODELNAME[]        = 'Smart Videohub';
...
#IF_DEFINED HAS_SWITCHER
    ...
    CHAR METADATA_PROPERTY_SWITCHER_LEVELS[20] = 'Video';
...
DEFINE_FUNCTION RegisterAssetParameters()
{
  ...
  RegisterAssetParametersSnapiComponents(assetClientKey);
    ...
    RMSAssetParameterExclude(assetClientKey,"'switcher.preset'")		//EXCLUDE THE SWITCHING PRESET ASSET PARAM
